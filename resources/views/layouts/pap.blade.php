...
<head>
	...
	<meta charset="utf-8">
	<meta name="description" content="Fashboard">
	<meta name="author" content="dashboard">
	<meta name="keyword" content="dahsboard">
	<meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>{{ config('app.name', 'Jakeyii') }}</title>
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>{{ Auth::user()->name }}</span></li>
                  <li class="dropdown avatar-dropdown">
                   <img src="admin/asset/img/avatar.jpg" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"/>
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="ripple">
                      <a href="change-password" class="tree-toggle nav-header">
                        <span class="fa-power-off fa"></span> Change Password
                      </a>
                    </li>
                  </ul>
                </div>
              ...
              <div class="tab-content">
                <div id="right-menu-user" class="tab-pane fade in active">
                  ...
                  <div class="user col-md-12">
                   <ul class="nav nav-list">
                    <li class="online">
                      <img src="admin/asset/img/avatar.jpg" alt="user name">
                      <div class="name">
                        ...
                        <div class="row msg_container send">
                          <div class="col-md-9 col-xs-9 bubble">
                            ...
                            <div class="col-md-3 col-xs-3 avatar">
                              <img src="admin/asset/img/avatar.jpg" class=" img-responsive " alt="user name">
                            </div>
                          </div>
                                ...
                                <ul>
                                  <li class="online">
                                    <a href=""  data-toggle="tooltip" data-placement="left" title="Akihiko avaron">
                                      <div class="user-avatar"><img src="admin/asset/img/avatar.jpg" alt="user name"></div>
                                      <div class="dot"></div>
                                    </a>
                                  </li>
                                  <li class="offline">
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-list fa"></span>Layout
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
...
<script src="admin/asset/js/plugins/flot/jquery.flot.min.js"></script>
<script src="admin/asset/js/plugins/flot/jquery.flot.pie.min.js"></script>
<script src="admin/asset/js/plugins/flot/jquery.flot.time.min.js"></script>
<script src="admin/asset/js/plugins/flot/jquery.flot.navigate.min.js"></script>
<script src="admin/asset/js/plugins/flot/jquery.flot.stack.min.js"></script>
